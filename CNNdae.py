...
ker_ysize = 18   # convolution kernel size in y direction
...
# initialize weight
W_e_init1 = tf.truncated_normal([ker_xsize, ker_ysize, 1, 16], mean=0.0, stddev=0.01)
W_e_init2 = tf.truncated_normal([ker_xsize, ker_ysize, 16,1], mean=0.0, stddev=0.01)
W_d_init1 = tf.truncated_normal([ker_xsize, ker_ysize, 16,1], mean=0.0, stddev=0.01)
W_d_init2 = tf.truncated_normal([ker_xsize, ker_ysize,  1,16], mean=0.0, stddev=0.01)
